	...
	public static Date strToDateY_M_D_H_M_S(String y_m_d_H_m_s) {
		if (!isBlankOrNull(y_m_d_H_m_s)) {
			try {
				...
				log.error("日期格式不正确" + y_m_d_H_m_s, e);
			}
		}
		return null;
	}
